...
export default function ManualPixelSetup() {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
      <h1 className="text-2xl font-bold mb-6">Manual Pixel Setup</h1>
      ...
      {shop ? (
        ...
        <div className="p-3 bg-yellow-50 text-yellow-700 rounded-md">
          ...
          <p className="text-sm mt-1">
            Example: <code>/manual-pixel-setup?shop=your-store.myshopify.com</code>
          </p>
        </div>
      )}
    </div>
